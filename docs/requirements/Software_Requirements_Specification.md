...
- **SR-01**: The system MUST authorize users via GCP Identity Platform Tokens (Bearer).
...
_Ref: Master App Dev Guide Section 4.0_

### 3.1 Core Entity Relationship Diagram (ERD) Abstract

- **User** (`users`): Identity root. Linked to GCP Identity UID.
