...
| `GATE-09` | Cross-surface copy consistency | Docs/support/legal/marketing have no `AI queries/day` phrasing and align with current policy/runtime behavior. | `AIR-028` |
