...
5. When implementing legal components (disclaimers, TOS, Privacy Policy), reference the documents in **legal/** to copy exact text and follow implementation requirements
...
**Last Updated:** December 19, 2025 at 01:45 PM CT (Modified 12/19/2025 13:45 Central Time per rules)
