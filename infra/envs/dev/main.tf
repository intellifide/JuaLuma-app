...
locals {
  ...
  cloud_run_services = {
    "jualuma-backend" = {
      image                 = "${var.region}-docker.pkg.dev/${var.project_id}/${var.artifact_registry_repo_id}/backend:latest"
      ...
      env = {
        ...
        PLAID_REDIRECT_URI   = "https://frontend-app-77ybfmw7cq-uc.a.run.app/connect-accounts"
        FRONTEND_URL         = "https://frontend-app-77ybfmw7cq-uc.a.run.app"
        BACKEND_CORS_ORIGINS = "https://frontend-app-77ybfmw7cq-uc.a.run.app"
      }
      secret_env = {
    ...
    "frontend-app" = {
      image                 = "${var.region}-docker.pkg.dev/${var.project_id}/${var.artifact_registry_repo_id}/frontend-app:latest"
      ingress               = "INGRESS_TRAFFIC_ALL"
      allow_unauthenticated = true
      ...
      cpu                   = "1"
      memory                = "512Mi"
      env                   = { API_UPSTREAM = "https://jualuma-backend-77ybfmw7cq-uc.a.run.app" }
      secret_env            = {}
    }

    "support-portal" = {
      image                 = "${var.region}-docker.pkg.dev/${var.project_id}/${var.artifact_registry_repo_id}/support-portal:latest"
      ingress               = "INGRESS_TRAFFIC_ALL"
      allow_unauthenticated = true
      service_account       = null
      attach_vpc_connector  = false
    ...
    "marketing-site" = {
      image                 = "${var.region}-docker.pkg.dev/${var.project_id}/${var.artifact_registry_repo_id}/marketing-site:latest"
      ingress               = "INGRESS_TRAFFIC_ALL"
      allow_unauthenticated = true
      service_account       = null
      attach_vpc_connector  = false
    ...
    "jualuma-approvals" = {
      image                 = "${var.region}-docker.pkg.dev/${var.project_id}/${var.artifact_registry_repo_id}/approvals-service:latest"
      ...
      env = {
        ...
        DISPATCH_ALLOWED_JOBS      = "jualuma-migrate-v2"
...
variable "existing_service_accounts" {
  ...
  type        = map(string)
  default = {
    backend   = "cr-backend@jualuma-dev.iam.gserviceaccount.com"
    approvals = "cr-approvals@jualuma-dev.iam.gserviceaccount.com"
  }
}
