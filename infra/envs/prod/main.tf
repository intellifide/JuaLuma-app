  ...
  cloud_run_services = {
    "jualuma-backend" = {
      ...
      env = {
        ...
        PLAID_REDIRECT_URI   = "https://app.jualuma.com/connect-accounts"
        FRONTEND_URL         = "https://app.jualuma.com"
        BACKEND_CORS_ORIGINS = "https://app.jualuma.com"
      }
      secret_env = {
    ...
    "frontend-app" = {
      ...
      cpu                   = "1"
      memory                = "512Mi"
      env                   = { API_UPSTREAM = "https://api.jualuma.com" }
      secret_env            = {}
    }
