            ...
            <section className="container max-w-[800px] py-12">
                <div className="glass-panel">
                    ...
                    <div className="max-w-[800px] mx-auto space-y-6">
                        ...
                        <p>Any disputes arising from or related to these Terms or the Service shall be resolved in the state or federal courts located in Texas.</p>

                        <h3>13.3 Arbitration</h3>
                        <p>Disputes may be resolved through binding arbitration as determined by applicable law and legal counsel.</p>
