    ...
    return (
        <div>
            <section className="container py-12">
                <h1 className="text-center mb-4 text-3xl font-bold">About Finity</h1>
                ...
                <div className="glass-panel mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="card">
                            ...
                            <p className="text-text-secondary">Finity is for informational and educational purposes only. We do not provide financial, investment, tax, or legal advice. Always consult qualified professionals for financial decisions.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="glass-panel mb-12">
                    ...
                    <div className="max-w-[800px] mx-auto space-y-4">
                        <p>
                            Finity is developed and operated by <strong>Intellifide, LLC</strong>, a Texas-based technology company focused on developing software applications in areas lacking innovation.
                        </p>
                        <p>
                            Intellifide, LLC is organized to develop and operate multiple software applications, with Finity being our flagship financial aggregation and analysis platform. We are committed to creating tools that simplify complex processes and provide immediate value to our users.
                        </p>
                        <p>
                ...
                <div className="glass-panel mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="card">
                            ...
                            <p className="text-text-secondary mb-2">
                                If you manage multiple accounts, spreadsheets, and crypto, Finity provides a robust aggregation engine. Our priority is on reliable multi-source data ingestion (Plaid, CEX APIs, Web3) and a unified feed that consolidates all activity into a single, clean interface.
                            </p>
                        </div>
                    </div>
                </div>
