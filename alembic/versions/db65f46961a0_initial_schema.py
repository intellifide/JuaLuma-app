...
def upgrade() -> None:
    ...
    op.alter_column('ai_settings', 'id',
               existing_type=sa.UUID(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('ai_settings', 'provider',
               ...
               server_default=None,
               existing_nullable=False)
    op.alter_column('ai_settings', 'model_id',
    ...
    op.alter_column('developer_payouts', 'id',
               existing_type=sa.UUID(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('developer_payouts', 'gross_revenue',
               existing_type=sa.NUMERIC(precision=18, scale=2),
               server_default=None,
               existing_nullable=False)
    op.alter_column('developer_payouts', 'payout_status',
               existing_type=sa.VARCHAR(length=32),
               server_default=None,
               existing_nullable=False)
    op.drop_constraint('developer_payouts_month_dev_uid_key', 'developer_payouts', type_='unique')
    op.create_unique_constraint('uq_payout_month_dev', 'developer_payouts', ['month', 'dev_uid'])
    op.drop_constraint('developers_uid_fkey', 'developers', type_='foreignkey')
    op.create_foreign_key(None, 'developers', 'users', ['uid'], ['uid'])
    op.alter_column('ledger_hot_essential', 'id',
               existing_type=sa.UUID(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('ledger_hot_essential', 'currency',
               existing_type=sa.VARCHAR(length=3),
               server_default=None,
               existing_nullable=False)
    op.create_foreign_key(None, 'ledger_hot_essential', 'users', ['uid'], ['uid'], ondelete='CASCADE')
    op.create_foreign_key(None, 'ledger_hot_essential', 'accounts', ['account_id'], ['id'], ondelete='CASCADE')
    op.alter_column('ledger_hot_free', 'id',
               existing_type=sa.UUID(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('ledger_hot_free', 'currency',
               existing_type=sa.VARCHAR(length=3),
               server_default=None,
               existing_nullable=False)
    op.create_foreign_key(None, 'ledger_hot_free', 'accounts', ['account_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(None, 'ledger_hot_free', 'users', ['uid'], ['uid'], ondelete='CASCADE')
    op.alter_column('manual_assets', 'id',
               existing_type=sa.UUID(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('notification_preferences', 'id',
               ...
               server_default=None,
               existing_nullable=False)
    op.alter_column('notification_preferences', 'channel_email',
               existing_type=sa.BOOLEAN(),
               server_default=None,
               nullable=False)
    op.alter_column('notification_preferences', 'channel_sms',
               existing_type=sa.BOOLEAN(),
               server_default=None,
               nullable=False)
    op.drop_constraint('notification_preferences_uid_event_key_key', 'notification_preferences', type_='unique')
    op.create_unique_constraint('uq_notification_event', 'notification_preferences', ['uid', 'event_key'])
    ...
    op.alter_column('subscriptions', 'status',
               ...
               server_default=None,
               nullable=True)
    op.alter_column('subscriptions', 'ai_quota_used',
    ...
    op.alter_column('support_agents', 'id',
               existing_type=sa.UUID(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('support_agents', 'active',
               existing_type=sa.BOOLEAN(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('support_ticket_ratings', 'id',
               existing_type=sa.UUID(),
               server_default=None,
               existing_nullable=False)
    op.drop_constraint('support_ticket_ratings_ticket_id_key', 'support_ticket_ratings', type_='unique')
    op.create_unique_constraint('uq_ticket_rating_ticket', 'support_ticket_ratings', ['ticket_id'])
    op.create_foreign_key(None, 'support_ticket_ratings', 'support_agents', ['agent_id'], ['id'], ondelete='CASCADE')
    ...
    op.alter_column('users', 'role',
               ...
               server_default=None,
               existing_nullable=False)
    op.alter_column('users', 'theme_pref',
               existing_type=sa.VARCHAR(length=32),
               server_default=None,
               existing_nullable=True)
    op.alter_column('users', 'currency_pref',
               existing_type=sa.VARCHAR(length=3),
               server_default=None,
               existing_nullable=True)
...
def downgrade() -> None:
    ...
    op.drop_constraint('uq_ticket_rating_ticket', 'support_ticket_ratings', type_='unique')
    op.create_unique_constraint('support_ticket_ratings_ticket_id_key', 'support_ticket_ratings', ['ticket_id'])
    op.alter_column('support_ticket_ratings', 'id',
               existing_type=sa.UUID(),
               server_default=sa.text('gen_random_uuid()'),
               existing_nullable=False)
    ...
    op.create_foreign_key('subscriptions_uid_fkey', 'subscriptions', 'users', ['uid'], ['uid'], ondelete='CASCADE')
    ...
    op.alter_column('payments', 'id',
               ...
               server_default=sa.text('gen_random_uuid()'),
               existing_nullable=False)
    op.drop_constraint('uq_notification_event', 'notification_preferences', type_='unique')
    op.create_unique_constraint('notification_preferences_uid_event_key_key', 'notification_preferences', ['uid', 'event_key'])
    op.alter_column('notification_preferences', 'channel_sms',
               existing_type=sa.BOOLEAN(),
    ...
    op.create_foreign_key('developers_uid_fkey', 'developers', 'users', ['uid'], ['uid'], ondelete='CASCADE')
    op.drop_constraint('uq_payout_month_dev', 'developer_payouts', type_='unique')
    op.create_unique_constraint('developer_payouts_month_dev_uid_key', 'developer_payouts', ['month', 'dev_uid'])
    op.alter_column('developer_payouts', 'payout_status',
               existing_type=sa.VARCHAR(length=32),
    ...
    op.create_foreign_key('accounts_uid_fkey', 'accounts', 'users', ['uid'], ['uid'], ondelete='CASCADE')
    op.alter_column('accounts', 'currency',
               existing_type=sa.VARCHAR(length=3),
               server_default=sa.text("'USD'::character varying"),
               existing_nullable=True)
