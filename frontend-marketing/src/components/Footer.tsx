      ...
      <div className="footer-grid">
        ...
        <div className="footer-section">
          ...
          <ul>
            ...
            <li><a href={`${APP_URL}/support/tickets/new`} target="_blank" rel="noreferrer">Submit Ticket</a></li>
        ...
        <div className="footer-section">
          ...
          <div className="social-links">
            ...
            <a className="social-link" href="https://github.com/intellifide/JuaLuma-app" target="_blank" rel="noreferrer" aria-label="GitHub">
